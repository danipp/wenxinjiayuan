    ...
    <el-upload :id="uuid" action="#" :class="['upload', self_disabled ? 'disabled' : '', drag ? 'no-border' : '']"
      ...
      <template v-if="imageUrl">
        ...
        <div class="upload-handle" @click.stop>
          <div v-if="!self_disabled && isEdit" class="handle-icon" @click="editImg">
            <el-icon>
              <Edit />
            </el-icon>
            <span>编辑</span>
          ...
          <div v-if="!self_disabled && isDel" class="handle-icon" @click="deleteImg">
            <el-icon>
              <Delete />
            </el-icon>
            <span>删除</span>
 ...
 * */
const emit = defineEmits(["update:imageUrl", "success"]);
...
const beforeUpload = rawFile => {
  console.log(rawFile.size / 1024 / 1024, props.fileSize);
