...
@Schema(name = "RESTFUL API")
public class Result<T> implements Serializable {
    @Schema(description = "状态码 {00000：成功 | A0401：未登录 | A0403：账号冻结 | B0001 系统执行出错，错误信息msg }")
    private String code;
    @Schema(description = "数据")
    private T data;
    @Schema(description = "成功/失败消息")
    private String msg;
    private long total;
...
//        }
    ...
    public static <T> Result<T> success(T data, int total) {
    	Long totalL = new Long(total);
    	return success(data,totalL);
    }
